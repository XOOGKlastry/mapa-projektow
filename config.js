...
window.KONFIG = {
  ...
  baza: {
    typ: 'lokalny',
    // Poprzedni projekt Supabase (dhzjqxhoiaroauimoepq) już nie istnieje (DNS nie
    // rozwiązuje hosta). Tryb lokalny = dane w przeglądarce, bez wspólnej bazy.
    // Żeby włączyć supabase ponownie: utwórz nowy projekt, uruchom
    // supabase/schema.sql, potem ustaw typ: 'supabase' i wklej url + klucz anon.
